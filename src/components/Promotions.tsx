...
export const Promotions = () => (
  <section id="promocoes" className="bg-slate-50 py-20">
    <div className="container mx-auto px-6 select-none">
      <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4">Pagamento Facilitado!</h2>
      ...
      <div className="grid lg:grid-cols-2 lg:grid-cols-3 gap-8">
        <PromoCard
          ...
          price={<p className="text-5xl font-extrabold text-primary">R$999</p>}
        ...
        <PromoCard
          ...
          price={<p className="text-5xl font-extrabold text-primary">R$99<span className="text-3xl">,99</span></p>}
        ...
        <PromoCard
          title="Parcele Tudo!"
          price={<p className="text-6xl font-extrabold text-primary">21x</p>}
