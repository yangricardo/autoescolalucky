    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <PromoCard
          ...
          price={<p className="text-5xl font-extrabold text-lucky-yellow">R$999</p>}
        ...
        <PromoCard
          ...
          price={<p className="text-5xl font-extrabold text-lucky-yellow">R$99<span className="text-3xl">,99</span></p>}
        ...
        <PromoCard
          title="Parcele Tudo!"
          price={<p className="text-6xl font-extrabold text-lucky-yellow">21x</p>}
