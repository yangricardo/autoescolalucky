...
export const Hero = () => (
  <section className="bg-blue-800 text-white select-none">
    <div className="container mx-auto px-6 py-20 md:py-28 text-center flex flex-col items-center">
      ...
      <p className="text-xl md:text-2xl mb-8 max-w-2xl text-yellow-300">Orçamento apertado não é mais desculpa! Na Autoescola Lucky, você realiza seu sonho com as melhores condições.</p>
