      ...
      <div className="w-full md:w-1/2 md:pr-10 mb-10 md:mb-0">
        ...
        <ul className="space-y-3 mb-8">
          <li className="flex items-start">
            <FaCheckCircle className="h-6 w-6 text-lucky-blue mt-1 mr-3 flex-shrink-0" />
            <span><strong>Prática Real:</strong> Enfrente situações reais do trânsito.</span>
          </li>
          <li className="flex items-start"><FaCheckCircle className="h-6 w-6 text-lucky-blue mt-1 mr-3 flex-shrink-0" /><span><strong>Atendimento Humanizado:</strong> Respeitamos seu tempo e seus medos.</span></li>
          <li className="flex items-start"><FaCheckCircle className="h-6 w-6 text-lucky-blue mt-1 mr-3 flex-shrink-0" /><span><strong>Evolução de Verdade:</strong> Sinta sua confiança aumentar a cada aula.</span></li>
        </ul>
        <div className="bg-yellow-100 border-l-4 border-lucky-yellow p-4 rounded-r-lg">
          <p className="text-xl font-bold">Pacotes a partir de <span className="text-lucky-blue text-3xl">R$79,90</span> por aula.</p>
        </div>
      </div>
