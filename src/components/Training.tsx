      ...
      <div className="w-full md:w-1/2 md:pr-10 mb-10 md:mb-0">
        ...
        <ul className="space-y-3 mb-8">
          <li className="flex items-start">
            <FaCheckCircle className="h-6 w-6 text-blue-800 mt-1 mr-3 flex-shrink-0" />
            <span><strong>Prática Real:</strong> Enfrente situações reais do trânsito.</span>
          </li>
          <li className="flex items-start"><FaCheckCircle className="h-6 w-6 text-blue-800 mt-1 mr-3 flex-shrink-0" /><span><strong>Atendimento Humanizado:</strong> Respeitamos seu tempo e seus medos.</span></li>
          <li className="flex items-start"><FaCheckCircle className="h-6 w-6 text-blue-800 mt-1 mr-3 flex-shrink-0" /><span><strong>Evolução de Verdade:</strong> Sinta sua confiança aumentar a cada aula.</span></li>
        </ul>
