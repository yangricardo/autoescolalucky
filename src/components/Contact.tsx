...
export const Contact = () => (
  <section id="contato" className="bg-blue-50 py-20">
    <div className="container mx-auto px-6">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 select-none">Fale Conosco</h2>
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full lg:w-1/2 px-4">
          <div className="rounded-xl shadow-lg overflow-hidden h-full select-none hover:shadow-blue-200 hover:shadow-lg transition-shadow duration-300">
            <iframe
