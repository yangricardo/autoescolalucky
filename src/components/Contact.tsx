      ...
      <div className="overflow-hidden p-4">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4 mb-10 lg:mb-0">
            <div className="bg-secondary text-white p-4 rounded-2xl shadow-lg h-full hover:shadow-amber-200 hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="rounded-2xl shadow-lg overflow-hidden h-full select-none hover:shadow-blue-200 hover:shadow-lg transition-shadow duration-300">
              <iframe
